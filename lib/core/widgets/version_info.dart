...
class VersionInfo {
  ...
  static const String fallbackVersionCode = '5';
  static const String fallbackVersionName = '4.4';
  ...
  /// version (e.g. "4.4"), `code` is the build/version code (e.g. "5"),
  /// and `display` is the combined `"4.4 (build 5)"` label used by the
...
/// A compact, theme-aware version caption ("v4.4 · build 5") rendered in
