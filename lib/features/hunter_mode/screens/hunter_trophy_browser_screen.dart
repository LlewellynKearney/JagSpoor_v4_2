...
class HunterTrophyBrowserScreen extends StatefulWidget {
  ...
  @override
  State<HunterTrophyBrowserScreen> createState() => _HunterTrophyBrowserScreenState();
}
...
class _HunterTrophyBrowserScreenState extends State<HunterTrophyBrowserScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Error loading trophies: $e'), backgroundColor: Colors.red),
        );
      }
    }
  }
  ...
  Future<void> _addToBookingLog() async {
    ...
    final selectedTrophies = _filteredTrophies
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            Text('Add to Booking Log', style: TextStyle(color: widget.theme.textColor)),
          ],
        ),
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              ...selectedTrophies.map((t) => Padding(
    ...
    if (confirmed == true) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Added ${selectedTrophies.length} trophy(ies) to your booking log!'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.location_on_rounded, color: theme.accentColor, size: 20),
                    const SizedBox(width: 8),
                    Expanded(
                      child: Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            items: _provinces.map((province) {
                              return DropdownMenuItem(
                                value: province,
                                child: Text(province, style: TextStyle(color: theme.textColor)),
                              );
                            }).toList(),
                            onChanged: (value) {
                              setState(() {
                ...
                : _filteredTrophies.isEmpty
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.pets_rounded, color: theme.subtitleColor.withValues(alpha: 0.5), size: 64),
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            ...
                            child: InkWell(
                              onTap: available > 0 ? () => _toggleTrophySelection(trophyId) : null,
                              borderRadius: BorderRadius.circular(12),
                              child: Padding(
                                padding: const EdgeInsets.all(16),
                                child: Row(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: TextStyle(color: theme.accentColor, fontSize: 10),
                                                ),
                                              ),
                                            ],
                                          ),
      ...
      bottomNavigationBar: _selectedTrophyIds.isNotEmpty
          ? Container(
              padding: const EdgeInsets.all(16),
              decoration: BoxDecoration(
                color: theme.cardColor,
