...
class FirearmMaintenanceScreen extends StatefulWidget {
  ...
  @override
  State<FirearmMaintenanceScreen> createState() =>
      _FirearmMaintenanceScreenState();
}
  ...
  Widget _taskTile(ThemeController theme, MaintenanceTask task) {
    ...
    return Card(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
          color: due ? Colors.red.withValues(alpha: 0.6) : Colors.transparent,
        ),
      ),
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(
                  due ? Icons.warning_amber_rounded : Icons.check_circle,
                  size: 14,
            ...
            Text(
              'Interval: every ${task.intervalRounds} rds',
