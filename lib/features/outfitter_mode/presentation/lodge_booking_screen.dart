                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                if (_clientNameController.text.isEmpty) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text('Client name required'),
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '🏠 ${booking['lodgingId'] ?? 'N/A'}',
                            style: const TextStyle(color: Colors.grey),
                          ),
                          Text(
                            '🚗 ${booking['vehicleId'] ?? 'None'}',
                            style: const TextStyle(color: Colors.grey),
                          ),
                          if (booking['arrivalDate'] != null)
                            Text(
                              '📅 ${booking['arrivalDate']} → ${booking['departureDate'] ?? 'TBD'}',
                              style: const TextStyle(color: Colors.grey),
                            ),
                        ],
                      ),
                      trailing: Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed:
                                () =>
                                    _showBookingForm(existingBooking: booking),
                          ),
                          IconButton(
